...
pub fn graph() {
    let drawing_area = BitMapBackend::new("test.png", (10, 10)).into_drawing_area();
    ...
    chart
        .draw_series(LineSeries::new(
            (0..num_steps+1).map(|t: i32| {
                (
                    bezier::bez_curve(t as f32 / num_steps as f32).0,
                    bezier::bez_curve(t as f32 / num_steps as f32).1,
